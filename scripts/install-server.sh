...
install_dir="${AGENTDB233_SERVER_INSTALL:-/usr/local/bin}"
[ "$OS" = "windows" ] && install_dir="${LOCALAPPDATA}/agentdb233"
...
echo "Run: AGENTDB233_DATA=~/.agentdb233-server ${BINARY_NAME}${ext} start"
echo "Status: ${BINARY_NAME}${ext} status"
echo "Change port: ${BINARY_NAME}${ext} set-port 32390"
echo "Enable boot autostart: ${BINARY_NAME}${ext} enable-autostart"
echo "Run MCP stdio: ${BINARY_NAME}${ext} mcp"
